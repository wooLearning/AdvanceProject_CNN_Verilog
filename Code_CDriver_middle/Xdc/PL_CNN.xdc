...
set_property PACKAGE_PIN F8 [get_ports iRstButton]
#set_property PACKAGE_PIN F7 [get_ports iStartButton]
...
set_property IOSTANDARD LVCMOS18 [get_ports iRstButton]
#set_property IOSTANDARD LVCMOS18 [get_ports iStartButton]
